export default {
  ...
  login: {
    ...
    registerAnnouncement1:
      "I promise that the ID and Password that you register here will not be public anywhere.",
    registerAnnouncement2:
      "If you got interest on me, you can click this message to visit my blog and leave a comment there.\n \nOr just contact me through this email\n[ hokori23@qq.com ]",
    registerAnnouncement3:
      "This is A website to record my assignment.\nIf you are my classmate you can feel free to register and login this website."
  },
  common: {
    confirm: "Confirm",
    cancel: "Cancel",
    ...
    unknownErrTip:
      "Something goes wrong, maybe effect the execution of the program, you can contact me on [hokori23@qq.com] if you in need.",
    save: "Save",
    continue: "Continue",
    finish: "Finish",
    back: "Back",
